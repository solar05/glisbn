...
-export([isbn10_checkdigit/1, isbn13_checkdigit/1, is_checkdigit_valid/1, is_valid/1, isbn10_to_13/1, isbn13_to_10/1, get_checkdigit/1, get_prefix/1, get_publisher_zone/1, main/0, get_registrant_element/1, get_publication_element/1, hyphenate/1, is_hyphens_correct/1]).
...
-spec main() -> {ok, binary()} | {error, isbn_error()}.
main() ->
    gleam@io:debug(get_publisher_zone(<<"9788535902778"/utf8>>)).
